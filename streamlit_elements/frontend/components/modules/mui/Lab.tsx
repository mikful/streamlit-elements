...
const elements: ElementsRecord = {
  ...
  ClockPicker: dynamic(() => import("@mui/x-date-pickers/ClockPicker"), { loading: ElementsLoading, ssr: false }),
  DatePicker: dynamic(() => import("@mui/x-date-pickers/DatePicker"), { loading: ElementsLoading, ssr: false }),
  DateTimePicker: dynamic(() => import("@mui/x-date-pickers/DateTimePicker"), { loading: ElementsLoading, ssr: false }),
  DesktopDatePicker: dynamic(() => import("@mui/x-date-pickers/DesktopDatePicker"), { loading: ElementsLoading, ssr: false }),
  DesktopDateTimePicker: dynamic(() => import("@mui/x-date-pickers/DesktopDateTimePicker"), { loading: ElementsLoading, ssr: false }),
  DesktopTimePicker: dynamic(() => import("@mui/x-date-pickers/DesktopTimePicker"), { loading: ElementsLoading, ssr: false }),
  ...
  MonthPicker: dynamic(() => import("@mui/x-date-pickers/MonthPicker"), { loading: ElementsLoading, ssr: false }),
  ...
  StaticDatePicker: dynamic(() => import("@mui/x-date-pickers/StaticDatePicker"), { loading: ElementsLoading, ssr: false }),
  StaticDateTimePicker: dynamic(() => import("@mui/x-date-pickers/StaticDateTimePicker"), { loading: ElementsLoading, ssr: false }),
  StaticTimePicker: dynamic(() => import("@mui/x-date-pickers/StaticTimePicker"), { loading: ElementsLoading, ssr: false }),
  ...
  TimePicker: dynamic(() => import("@mui/x-date-pickers/TimePicker"), { loading: ElementsLoading, ssr: false }),
